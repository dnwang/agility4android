...
//        }
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                // FIXME denan.wang; 2014/9/27; 最多只能在xml中包含一个子视图
                if (getChildCount() > 4) {
...
//        }
    ...
    protected void addRefreshableView(Context context, T refreshableView) {
        ...
        // 创建一个包装容器
        // FIXME denan.wang; 2014/9/27; 不使用包装，减少视图层级关系
...
//        System.out.println("onStateChanged() --> " + state + ", " + isPullDown);
     ...
     * @author denan.wang
     * @date 2014/9/18
     * @description 是否只回弹（该设置仅仅是隐藏上拉，下拉视图，并不对其中逻辑做任何处理）
     * <br/>
     * PS: true 不会回调 {@link OnRefreshListener} ！
     */
