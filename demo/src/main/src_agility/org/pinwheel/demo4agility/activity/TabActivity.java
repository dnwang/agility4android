...
public class TabActivity extends Activity {
    ...
    protected void onCreate(Bundle arg0) {
        super.onCreate(arg0);
        this.setContentView(org.pinwheel.demo4agility.R.layout.tab_left);

        slidingPane = (SlidingPaneLayout) findViewById(org.pinwheel.demo4agility.R.id.sliding);
        slidingPane.setShadowResourceLeft(org.pinwheel.demo4agility.R.drawable.shadow_right);

        controller = new TabController(
                (ViewGroup) findViewById(org.pinwheel.demo4agility.R.id.item_group),
                (ViewPager) findViewById(org.pinwheel.demo4agility.R.id.pager),
                (TabController.ISelectable) findViewById(org.pinwheel.demo4agility.R.id.selector));

//        controller.setSelector(getResources().getDrawable(org.pinwheel.demo.R.drawable.ic_selector));
...
//            page1_controller.addTabs(testTab);
    ...
    public View createTestPage2() {
        View contentLayout = LayoutInflater.from(this).inflate(org.pinwheel.demo4agility.R.layout.tab_top, null, false);
