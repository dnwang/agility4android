 ...
 * @description
 */
public class AnimatorRadioButton extends RadioButton {

    protected TouchAnimator touchAnimator;

    public AnimatorRadioButton(Context context) {
        super(context);
        init(context);
    }

    public AnimatorRadioButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public AnimatorRadioButton(Context context, AttributeSet attrs, int defStyle) {
